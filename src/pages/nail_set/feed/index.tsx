...
type NailSetFeedRouteProp = RouteProp<RootStackParamList, 'NailSetFeedPage'>;
type NailSetFeedNavigationProp = NativeStackNavigationProp<RootStackParamList>;

/**
 * 네일 세트 피드 페이지
 * 특정 스타일의 네일 세트 목록을 보여줍니다.
 */
function NailSetFeedPage() {
  const navigation = useNavigation<NailSetFeedNavigationProp>();
  const route = useRoute<NailSetFeedRouteProp>();
  ...
  const {
    ...
    queryKey: ['nailSetFeed', styleId, styleName],
...
export default NailSetFeedPage;
